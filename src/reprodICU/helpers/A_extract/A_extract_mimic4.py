...
class MIMIC4Extractor(MIMIC4Paths):
    ...
    def _extract_specialties(self) -> pl.LazyFrame:
        ...
        return (
            ...
            .join(IDs, on=self.person_id_col)
            .with_columns(
    ...
    def _compute_cam_icu(self, data: pl.LazyFrame) -> pl.LazyFrame:
        ...
        Steps:
            ...
            3. Join component scores and compute overall delirium status.
            4. Group by patient/time and select first valid score.
    ...
    def extract_lab_measurements(self) -> pl.LazyFrame:
        ...
        return (
            labevents.select(
                "subject_id", "specimen_id", "itemid", "charttime", "valuenum"
            )
            # Rename columns for consistency
            .rename({"subject_id": self.person_id_col})
            .with_columns(
