...
class MAGIC_CONCEPTS_REPOSITORY:
    def __init__(self, paths, datasets):
        ...
        from .RECEIVED_ANY_ANTIBIOTICS import RECEIVED_ANY_ANTIBIOTICS as ANY_ABX
        from .RENAL_REPLACEMENT_THERAPY_DURATION import RENAL_REPLACEMENT_THERAPY_DURATION as RRT_DURATION
