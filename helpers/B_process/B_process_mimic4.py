...
#             )
#             droplist = list(
#                 set(ts_vitals.collect_schema().names())
#                 - set([self.icu_stay_id_col, self.timeseries_time_col])
#             )
#             ts_vitals = (
#                 ts_vitals.pipe(
#                     self.helpers.dropna,
...
#                 .with_columns(
#                     pl.when(
#                         pl.col("temperature_F").is_not_null() & pl.col("temperature").is_null(),
#                     )
#                     .then(
#                         pl.col("temperature_F")
#                         .sub(pl.lit(32))
#                         .mul(pl.lit(5 / 9))
#                         .alias("temperature")
#                     )
...
#             )
#             droplist = list(
#                 set(ts_lab.collect_schema().names())
#                 - set([self.icu_stay_id_col, self.timeseries_time_col])
#             )
#             ts_lab = (
#                 ts_lab.pipe(
...
#             )
#             droplist = list(
#                 set(ts_inout.collect_schema().names())
#                 - set([self.icu_stay_id_col, self.timeseries_time_col])
#             )
#             ts_inout = (
#                 ts_inout.pipe(
