Since unfortunately, I haven't yet figured out whether it's possible to add singular files from another repository as a submodule, manual updating has to suffice.
